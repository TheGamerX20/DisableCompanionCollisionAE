...
-- set project
set_project("DisableCompanionCollisionAE")
set_license("GPL-3.0")
...
-- targets
target("DisableCompanionCollisionAE")
    -- add dependencies to target
    add_deps("commonlibf4")

    -- add commonlibsse plugin
    add_rules("commonlibf4.plugin", {
        name = "DisableCompanionCollisionAE",
        author = "TheGamerX20",
        description = "Disable Companion Collision for AE!"
    })
